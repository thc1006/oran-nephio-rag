...
class TestPuterRAGSystem:
    ...
    def test_load_existing_database_success(self, mock_create_puter):
        ...
        test_data = {
            "documents": [
                {
                    "id": "test123",
                    "content": "Test content about Nephio",
                    "metadata": {"source": "test"}
                }
            ],
            "doc_index": {
                "test123": ["nephio", "content", "test"]
            }
        }
    ...
    def test_build_vector_database(self, mock_doc_loader_class, mock_create_puter):
        ...
        with patch.object(system.vectordb, 'add_documents') as mock_add, \
...
class TestSimplifiedVectorDatabase:
    ...
    def test_save_and_load(self):
        ...
        test_docs = [
            Document(
                page_content="Test content for save/load",
                metadata={"source": "test"}
            )
        ]
