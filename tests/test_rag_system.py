    ...
    def test_query_success(self, mock_create_puter):
        ...
        test_source_docs = [
            Document(
                ...
                metadata={"source_url": "https://test.com", "source_type": "nephio", "description": "Test Doc"},
            )
        ]

        mock_puter_result = {"answer": "This is a test answer about Nephio scaling.", "model": "claude-sonnet-4"}
