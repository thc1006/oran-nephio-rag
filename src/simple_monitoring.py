...
class SimpleMetricsCollector:
    ...
    def __init__(self) -> None:
        ...
        self.system_metrics = SystemMetrics(
            timestamp=datetime.now().isoformat(), cpu_usage=0.0, memory_usage=0.0, disk_usage=0.0
        )
    ...
    @contextmanager
    def track_query(self, query_type: str = "default") -> Generator[None, None, None]:
        """追蹤查詢執行時間的上下文管理器"""
    ...
    def record_documents_loaded(self, count: int) -> None:
        """記錄載入的文件數量"""
        self.app_metrics.documents_loaded = count
        self.app_metrics.timestamp = datetime.now().isoformat()

    def set_vectordb_status(self, ready: bool) -> None:
        """設定向量資料庫狀態"""
...
class SimpleHealthChecker:
    ...
    def check_health(self) -> Dict[str, Any]:
        """執行健康檢查"""
        health_status: Dict[str, Any] = {"status": "healthy", "timestamp": datetime.now().isoformat(), "checks": {}}
    ...
    def _check_vectordb_status(self) -> Dict[str, Any]:
        ...
        return {"status": "healthy", "ready": True, "documents_loaded": app_metrics.documents_loaded, "issues": []}
